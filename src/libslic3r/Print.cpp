...
bool Print::invalidate_state_by_config_options(const ConfigOptionResolver & /* new_config */, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    static std::unordered_set<std::string> steps_gcode = {
        ...
        "gcode_comments",
        "gcode_label_objects",
        "injection_pour_enabled",
        "injection_pour_auto_from_model",
        "injection_pour_part_name",
        "injection_pour_port_name",
        "injection_pour_volume_multiplier",
        "injection_pour_extruder",
        "injection_pour_x",
        "injection_pour_y",
        "injection_pour_z",
        "injection_pour_start_z",
        "injection_pour_end_z",
        "injection_pour_volume",
        "injection_pour_flow",
        "injection_pour_temperature",
        "injection_pour_dwell",
        "nozzle_high_flow",
        "infill_acceleration",
        "layer_gcode",
        "min_fan_speed",
