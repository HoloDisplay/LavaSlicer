...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionBool,               injection_pour_enabled))
    ((ConfigOptionBool,               injection_pour_auto_from_model))
    ((ConfigOptionString,             injection_pour_part_name))
    ((ConfigOptionString,             injection_pour_port_name))
    ((ConfigOptionFloat,              injection_pour_volume_multiplier))
    ((ConfigOptionInt,                injection_pour_extruder))
    ((ConfigOptionFloat,              injection_pour_x))
    ((ConfigOptionFloat,              injection_pour_y))
    ((ConfigOptionFloat,              injection_pour_z))
    ((ConfigOptionFloat,              injection_pour_start_z))
    ((ConfigOptionFloat,              injection_pour_end_z))
    ((ConfigOptionFloat,              injection_pour_volume))
    ((ConfigOptionFloat,              injection_pour_flow))
    ((ConfigOptionInt,                injection_pour_temperature))
    ((ConfigOptionFloat,              injection_pour_dwell))
