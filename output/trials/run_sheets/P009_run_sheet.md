...
- Plunge: 2 mm
- Dwell: 1 s
- Primary metric: leakage score
- Expected label: leakage or softening
- Purpose: High-temperature high-flow trial should expose upper-bound leakage or softening and should be sectioned if retained.

## Required Evidence Paths

- Planned injection block: `output/trials/planned/p009_275c_30mm3s_top_pour.gcode`
- Mold model: `paper/molds/P009_mold.stl`
- Executed G-code: `paper/gcode/P009_executed.gcode`
- Top photo: `paper/photos/P009_top.jpg`
- Side photo: `paper/photos/P009_side.jpg`
- Section/removed photo: `paper/photos/P009_section.jpg`
