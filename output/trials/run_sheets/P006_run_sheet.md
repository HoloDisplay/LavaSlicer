...
- Purpose: High-temperature mid-flow trial checks whether improved fill causes leakage or mold deformation.

## Required Evidence Paths

- Planned injection block: `output/trials/planned/p006_275c_20mm3s_top_pour.gcode`
- Mold model: `paper/molds/P006_mold.stl`
- Executed G-code: `paper/gcode/P006_executed.gcode`
- Top photo: `paper/photos/P006_top.jpg`
- Side photo: `paper/photos/P006_side.jpg`
