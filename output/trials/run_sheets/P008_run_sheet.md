...
- Purpose: Mid-temperature high-flow trial tests practical melt-delivery limit.

## Required Evidence Paths

- Planned injection block: `output/trials/planned/p008_255c_30mm3s_top_pour.gcode`
- Mold model: `paper/molds/P008_mold.stl`
- Executed G-code: `paper/gcode/P008_executed.gcode`
- Top photo: `paper/photos/P008_top.jpg`
- Side photo: `paper/photos/P008_side.jpg`
