...
- Purpose: Mid-temperature low-flow trial tests whether temperature alone improves bottom fill.

## Required Evidence Paths

- Planned injection block: `output/trials/planned/p002_255c_10mm3s_top_pour.gcode`
- Mold model: `paper/molds/P002_mold.stl`
- Executed G-code: `paper/gcode/P002_executed.gcode`
- Top photo: `paper/photos/P002_top.jpg`
- Side photo: `paper/photos/P002_side.jpg`
