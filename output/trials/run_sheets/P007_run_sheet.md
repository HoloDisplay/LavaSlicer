...
- Plunge: 2 mm
- Dwell: 1 s
- Primary metric: flow limit
- Expected label: flow limit
- Purpose: Low-temperature high-flow trial tests under-melted extrusion or firmware flow limiting.

## Required Evidence Paths

- Planned injection block: `output/trials/planned/p007_240c_30mm3s_top_pour.gcode`
- Mold model: `paper/molds/P007_mold.stl`
- Executed G-code: `paper/gcode/P007_executed.gcode`
- Top photo: `paper/photos/P007_top.jpg`
- Side photo: `paper/photos/P007_side.jpg`
